...
begin
    ...
    begin
        ...
        //if (Pos > 6) then
        //   DataBuffer[Pos][Channel] := (((Volt[Channel] + DataShift[Channel]) * Coefficient[Channel]) + DataBuffer[Pos - 1][Channel] + DataBuffer[Pos - 2][Channel] + DataBuffer[Pos - 3][Channel] + DataBuffer[Pos - 4][Channel] + DataBuffer[Pos - 5][Channel]) / 6
        //else
